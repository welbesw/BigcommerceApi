...
// BigcommerceApi
#define COCOAPODS_POD_AVAILABLE_BigcommerceApi
#define COCOAPODS_VERSION_MAJOR_BigcommerceApi 0
#define COCOAPODS_VERSION_MINOR_BigcommerceApi 1
#define COCOAPODS_VERSION_PATCH_BigcommerceApi 0
